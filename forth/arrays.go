...
func arrayWordsInit(vm *VM) {
	vm.Define(Word{Name: "bytes", Run: bytes, Immediate: false})
	vm.Define(Word{Name: "ints", Run: ints, Immediate: false})
	vm.Define(Word{Name: "floats", Run: floats, Immediate: false})
	vm.Define(Word{Name: "strings", Run: stringArray, Immediate: false})
	vm.Define(Word{Name: "@", Run: arrayGet, Immediate: false})
	vm.Define(Word{Name: "!", Run: arraySet, Immediate: false})
	vm.Define(Word{Name: "c@", Run: byteGet, Immediate: false})
	vm.Define(Word{Name: "c!", Run: byteSet, Immediate: false})
	vm.Define(Word{Name: "@push", Run: arrayPush, Immediate: false})
	vm.Define(Word{Name: "@pop", Run: arrayPop, Immediate: false})
	vm.Define(Word{Name: "@shift", Run: arrayShift, Immediate: false})
	vm.Define(Word{Name: "@unshift", Run: arrayUnshift, Immediate: false})
	vm.Define(Word{Name: "@len", Run: arrayLen, Immediate: false})
}
